...
I am a third-year PhD student in Computer Science at the [University of Massachusetts Amherst](https://www.umass.edu/), being co-advised by Dr. [Madalina Fiterau](https://people.cs.umass.edu/~mfiterau/) at the [Information Fusion](https://groups.cs.umass.edu/infofusion/home/) lab and Dr. [Anna Green](https://sage.cs.umass.edu/author/anna-green/) at the [Sequence Analysis and Genomics (SAGE)](https://sage.cs.umass.edu/) lab. Now I am a Machine Learning Co-op (research intern) at Biogen, Synthetic Medicine Design, supervised by Dr. [Ye Wang](https://www.yewang.org/).

My research develops deep learning methods for generation and representation learning under real-world constraints. I work on multimodal representation learning, controllable generative models, the adaptation of pretrained language models, and reinforcement learning. Rather than treating them separately, I study how they combine into a single pipeline and use each component to improve or evaluate the others. I care as much about explaining why a method works or fails as about improving its numbers, and I pair method development with empirical analysis of robustness and generalization across molecular science and healthcare.
